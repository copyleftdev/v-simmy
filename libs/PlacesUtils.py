...
class PlacesProvider(object):
    ...
    def __init__(self):
        self.coun = pkl.load(open("{}/data/countries.p".format(p_path), "rb"))
    ...
    def get_random_country(self):
        return random.choice(self.coun)
    ...
    def get_random_country_and_place(self):
        country, place = [
            random.choice(self.coun),
            random.choice(self.places)
        ]
        rnd_dict = {"country": random.choice(self.coun),
